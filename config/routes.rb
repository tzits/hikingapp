Rails.application.routes.draw do
  ...
  get '/lists/:id/categories/:category_id/items/new', to: 'items#new', as: 'items_new'
  ...
  patch '/lists/:id/categories/:category_id/items/new', to: 'categories#remove_item', as: 'cat_item'
end
